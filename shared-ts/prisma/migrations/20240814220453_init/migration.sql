/*
  ...
  - Added the required column `disruptionStartDate` to the `disruptions` table without a default value. This is not possible if the table is not empty.
  - Added the required column `disruptionStartTime` to the `disruptions` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "disruptions" ADD COLUMN     "disruptionEndDate" TEXT,
