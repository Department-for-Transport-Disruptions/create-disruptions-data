...
export const periodSchema = z
    ...
    .refine((obj) => (obj.EndTime ? dayjs(obj.EndTime).isAfter(dayjs(obj.StartTime)) : true), "End Time must be after Start Time");
...
export const placesSchema = z.object({
    AffectedPlace: z.array(z.object({
        PlaceRef: z.string(),
        PlaceName: z.string(),
...
export const stopPointsSchema = z.object({
    AffectedStopPoint: z.array(z.object({
...
export const journeysSchema = z.object({
    AffectedVehicleJourney: z.array(z.object({
...
export const ptSituationElementSchema = basePtSituationElementSchema.and(z
