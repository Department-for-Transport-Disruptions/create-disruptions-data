...
import { affectedOperatorSchema, basePtSituationElementSchema, consequenceSchema, infoLinkSchema, networksSchema, operatorsSchema, periodSchema, ptSituationElementSchema, referenceSchema, repetitionsSchema, serviceDeliverySchema, siriSchema, situationElementRefSchema, situationExchangeDeliverySchema, situationsSchema, sourceSchema, stopPointsSchema } from "./siriTypes.zod";
...
export declare const isMiscellaneousReason: (reason: Reason) => reason is MiscellaneousReason;
export declare const isEquipmentReason: (reason: Reason) => reason is EquipmentReason;
export declare const isPersonnelReason: (reason: Reason) => reason is PersonnelReason;
export declare const isEnvironmentReason: (reason: Reason) => reason is EnvironmentReason;
