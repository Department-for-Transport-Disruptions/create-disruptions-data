...
export const CREATE_TEMPLATE_PAGE_PATH = "/create-template";
export const TYPE_OF_CONSEQUENCE_PAGE_PATH = "/type-of-consequence";
export const TYPE_OF_CONSEQUENCE_TEMPLATE_PAGE_PATH = "/type-of-consequence-template";
...
export const CREATE_TEMPLATE_CONSEQUENCE_OPERATOR_PATH = "/create-template-consequence-operator";
export const CREATE_TEMPLATE_CONSEQUENCE_NETWORK_PATH = "/create-template-consequence-network";
export const CREATE_TEMPLATE_CONSEQUENCE_STOPS_PATH = "/create-template-consequence-stops";
export const CREATE_TEMPLATE_CONSEQUENCE_SERVICES_PATH = "/create-template-consequence-services";
export const REVIEW_DISRUPTION_PAGE_PATH = "/review-disruption";
export const DISRUPTION_DETAIL_PAGE_PATH = "/disruption-detail";
export const TEMPLATE_OVERVIEW_PAGE_PATH = "/template-overview";
export const REVIEW_TEMPLATE_PAGE_PATH = "/review-template";
...
export const COOKIES_TEMPLATE_ERRORS = "cdd-disruption-errors";
export const COOKIES_CONSEQUENCE_TYPE_ERRORS = "cdd-consequence-type-errors";
export const COOKIES_CONSEQUENCE_TYPE_TEMPLATE_ERRORS = "cdd-consequence-type-errors";
...
export const COOKIES_TEMPLATE_CONSEQUENCE_OPERATOR_ERRORS = "cdd-consequence-operator-errors";
export const COOKIES_TEMPLATE_CONSEQUENCE_NETWORK_ERRORS = "cdd-consequence-network-errors";
export const COOKIES_TEMPLATE_CONSEQUENCE_STOPS_ERRORS = "cdd-consequence-stops-errors";
export const COOKIES_TEMPLATE_CONSEQUENCE_SERVICES_ERRORS = "cdd-consequence-services-errors";
