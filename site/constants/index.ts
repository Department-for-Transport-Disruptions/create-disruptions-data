...
export const DISRUPTION_STATUSES: DisplayValuePair<PublishStatus>[] = [
    { value: PublishStatus.editing, display: "Editing" },
    {
    ...
    { value: PublishStatus.published, display: "Published" },
];
