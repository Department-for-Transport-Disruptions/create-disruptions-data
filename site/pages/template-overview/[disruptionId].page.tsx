...
const description = "Template Overview page for the Create Transport Disruptions Service";
...
const TemplateOverview = ({ disruption, csrfToken, errors, canPublish }: DisruptionDetailProps): ReactElement => {
    ...
    return (
        <BaseLayout title={title} description={description}>
            ...
            <CsrfForm action="/api/publish-edit-template" method="post" csrfToken={csrfToken}>
                <>
                    ...
                    <div className="govuk-form-group">
                        ...
                        {(disruption.publishStatus === PublishStatus.published ||
                            ...
                            <button
                                ...
                                formAction={`/api/create-disruption-from-template?templateId=${disruption.disruptionId}`}
                            >
                                Create disruption
                            </button>
                        )}
                        ...
                        disruption.publishStatus === PublishStatus.pendingAndEditing ? (
                            <button
                                ...
                                data-module="govuk-button"
                                formAction="/api/cancel-template-changes"
                            >
                                Cancel all changes
                            </button>
                        ) : null}
...
export const getServerSideProps = async (
    ...
    const errorCookie = cookies[COOKIES_TEMPLATE_OVERVIEW_ERRORS];
    ...
    if (ctx.res) destroyCookieOnResponseObject(COOKIES_TEMPLATE_OVERVIEW_ERRORS, ctx.res);
