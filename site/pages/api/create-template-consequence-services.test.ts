...
describe("create-template-consequence-services API", () => {
    ...
    it("should redirect to /review-template when all required inputs are passed with stops", async () => {
    ...
    it("should redirect back to /create-template-consequence-services when description is too long", async () => {
        const stopsData = {
            ...defaultServicesData,
            description:
    ...
    it("should redirect to /review-template when all required inputs are passed  with appropriate query params when a new disruption is created from template", async () => {
        const { req, res } = getMockRequestAndResponse({
            body: defaultServicesData,
            requestHeaders: {
                referer: refererPath,
